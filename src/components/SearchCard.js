          ...
          <Box sx={{
            ...
            <Box sx={{ display: 'flex', 
                ...
                <Typography variant="body2" color="#644D3E">
                  Estimasi waktu : {searching.times}
                </Typography>
                <Typography variant="body2" color="#644D3E">
                  Porsi : {searching.servings}
                </Typography>
                <Typography variant="body2" color="#644D3E">
                  Level : {searching.dificulty}
                </Typography>
                  <br />
                <ColorButton href={`/detail/${searching.key}`}
                  fullWidth
                  variant="contained"
